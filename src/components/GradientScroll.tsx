...
interface GradientScrollProps extends React.PropsWithChildren{
  // Width of the gradient on each side.
  width: string; // Any valid CSS width string (e.g., rem, em, px, %, calc()).
...
export default function GradientScroll(props: GradientScrollProps): ReactNode{
  ...
  return(
    <div className="gradient-scroll position-relative">
